...
return [
    ...
    */
    ...
    'appointment' => [
        ...
        'notify_url' => env('APPOINTMENT_NOTIFY_URL', 'https://r1riepas.lv/appoApi/'),
    ],
    ...
    */
    ...
    | WHATSAPP_PARALLEL_TEST_MODE=false → same group JIDs as TextMeBot (urs/krs; shop uses orderWpp in ShopController).
    */
    'whatsapp_parallel' => [
