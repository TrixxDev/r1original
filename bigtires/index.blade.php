                          ...
                          <div class="tire-list-caption">
                            ...
                            <div style="display: flex;">
                              ...
                              <button style="margin-left: auto;"
                                      ...
                                      data-url="{{ route('lielas-riepa', [strtolower(\Tires::getBigTireBrand($tire->tread->brand_id)->title), strtolower(str_replace('/', '_', $tire->tread->title)), $tire->tire_id]) }}"
...
{{--                        LI/SI--}}
                        ...
                        <td class="shopping-cart-col">
                          <div class="clearfix atc_div text-right">
                            <button class="cart-shopping-button" data-toggle="modal"
                              @hasrole('administrators') data-target="#" @else data-target="#blockcart-modal" @endhasrole data-info="{{ $tire->tire_id }}" data-url="{{ route('lielas-riepa', [strtolower(\Tires::getBigTireBrand($tire->tread->brand_id)->title), strtolower(str_replace('/', '_', $tire->tread->title)), $tire->tire_id]) }}" data-link="/lielas-riepas"><i
  ...
  <script src="{{ asset('js/bigTiresAjax.js?rev=' . time()) }}"></script>
@endsection
