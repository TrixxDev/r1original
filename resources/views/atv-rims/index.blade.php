...
@section('meta_keywords', config('seo.keywords.atv_rims'))
@section('canonical_url', route('kvadraciklu-diski'))
...
@push('scripts')
  ...
  <script src="{{ \App\Helper\AssetHelper::v('js/atv-rims.js') }}" defer></script>
@endpush
