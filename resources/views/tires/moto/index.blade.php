...
@section('meta_description', 'Motociklu riepas ar filtriem pēc izmēra un ražotāja. Moto riepas internetā — R1 Riepu Serviss katalogs.')
@section('meta_keywords', config('seo.keywords.moto'))
@section('canonical_url', route('motociklu-riepas'))
      ...
      <div class="main-content clearfix col-md-12 col-xl-12">
        ...
        <div id="content-wrapper" class="col-md-12 col-lg-9">
          <section id="main">
            ...
            @include('components.mototires.catalog-seo')
          </section>
        </div>
      </div>
    </div>
...
@push('scripts')
<script src="{{ \App\Helper\AssetHelper::v('js/motoTiresAjax.js') }}" defer></script>
@endpush
@endsection
