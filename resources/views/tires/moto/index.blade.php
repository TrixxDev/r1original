                      ...
                      <li class="show-selected-checkbox-li">
                        <label class="facet-label" for="show-selected-checkbox"
                          ...
                          <span class="custom-checkbox">
                            <input type="checkbox" value="only_selected" class="tire-table-checkbox" id="show-selected-checkbox" title="Rādīt tikai atzīmētās preces" @if (request()->show_selected) checked @endif disabled>
                  ...
                  <section class="facet clearfix facet--4">
                    ...
                    <ul id="facet_type" class="collapse">
                      @foreach ($types as $index => $value)
                        @php $index = strtolower($index); $smallValue = str_replace(' ', '', strtolower($value)); @endphp
                        <li data-label="{{ $index }}">
                          <label class="facet-label" for="facet_for_{{ $index }}">
                          <span class="custom-checkbox">
                            <input id="facet_for_{{ $index }}" data-search-url="" @if (in_array($smallValue, explode(' ', request()->type))) checked="" @endif value="{{ $value }}" data-for="prod-type" data-value="{{ $smallValue }}" type="checkbox">
                            <span class="ps-shown-by-js">
                              <i class="material-icons checkbox-checked"></i>
                            </span>
                          </span>
