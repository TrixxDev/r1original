...
@section('title', 'lang-' . app()->getLocale() . ' country-' . app()->getLocale() . ' layout-both-columns page-category tax-display-enabled category-id-14 category-ziemas-riepas category-id-parent-12 category-depth-level-3')
                                            ...
                                            <li data-label="Top+40">
                                                <label class="facet-label" for="facet_input_39112_0">
                                                    <span class="custom-checkbox">
                                                        <input id="facet_input_39112_0" data-search-url="http://r1riepas.lv/index.php?controller=category&amp;id_category=14&amp;id_lang=2&amp;q=Platums-205/Augstums-55/Diametrs-16/TOP40-Top+40" type="checkbox">
                                        ...
                                        <ul id="facet_11641" class="collapse">
                                            <li data-label="XL">
                                                <label class="facet-label" for="facet_input_11641_0">
                                                    <span class="custom-checkbox">
                                                        <input id="facet_input_11641_0" data-search-url="http://r1riepas.lv/index.php?controller=category&amp;id_category=14&amp;id_lang=2&amp;q=Platums-205/Augstums-55/Diametrs-16/Kods-XL" type="checkbox">
                                                        <span class="ps-shown-by-js">
                                                            <i class="material-icons checkbox-checked"></i>
                                                        </span>
                                                    </span>
                                            ...
                                            <li data-label="RSC">
                                                <label class="facet-label" for="facet_input_11641_1">
                                                    <span class="custom-checkbox">
                                                        <input id="facet_input_11641_1" data-search-url="http://r1riepas.lv/index.php?controller=category&amp;id_category=14&amp;id_lang=2&amp;q=Platums-205/Augstums-55/Diametrs-16/Kods-RSC" type="checkbox">
                                                        <span class="ps-shown-by-js">
                                                            <i class="material-icons checkbox-checked"></i>
                                                        </span>
                                                    </span>
                                        ...
                                        <ul id="facet_37451" class="collapse">
                                            <li data-label="M%2BS">
                                                <label class="facet-label" for="facet_input_37451_0">
                                                    <span class="custom-checkbox">
                                                        <input id="facet_input_37451_0" data-search-url="http://r1riepas.lv/index.php?controller=category&amp;id_category=14&amp;id_lang=2&amp;q=Platums-205/Augstums-55/Diametrs-16/Tips-M%2BS" type="checkbox">
                                                        <span class="ps-shown-by-js">
                                                            <i class="material-icons checkbox-checked"></i>
                                                        </span>
                                                    </span>
                                        ...
                                        <nav data-depth="3" class="breadcrumb hidden-sm-down">
                                            <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                                ...
                                                <li itemprop="itemListElement" itemscope=""
                                                    ...
                                                    <a itemprop="item"
                                                       href="{{ url()->full() }}">
                                                        <span itemprop="name">Ziemas riepas</span>
                                                    </a>
                            ...
                            <div id="">
                                <div id="js-product-list">
                                    <div class="products row hide-price">
                                        ...
                                        @foreach ($brands as $brand)
                                            <h4 class="custom_brand_name product_list_view" data-brand="{{ $brand->id }}"
                                                style="display: none;">{{ strtoupper($brand->title) }}</h4>
                                        @endforeach
                                        @foreach ($tires as $tire)
                                            @php $tire->_includeStock = true; @endphp
                                            <article class="product_show_list cat-14 product-miniature js-product-miniature"
                                                ...
                                                <div class="thumbnail-container">
                                                    <a href="{{ route('vasaras-riepa', [strtolower(\Tires::getAutoTireBrand($tire->tread->brand_id)->title), \Str::slug(strtolower($tire->tread->title), '-'), $tire->tire_id]) }}"
                                                    ...
                                                    <div class="product-description">
                                                        ...
                                                        <h1 class="h3 product-title" itemprop="name">
                                                            <a data-toggle="tooltip" data-html="true"
                                                               title="<img src='{{ asset('img\p\en-default-home_default.jpg') }}' style='width: 280px; height: 280px;'>"
                                                               href="{{ route('vasaras-riepa', [strtolower(\Tires::getAutoTireBrand($tire->tread->brand_id)->title), \Str::slug(strtolower($tire->tread->title), '-'), $tire->tire_id]) }}"
                                                    ...
                                                    <div class="clearfix atc_div">
                                                        <button class="btn grid-cart-btn btn-primary"
                                                                ...
                                                                data-callback-param="{{ $tire->tire_id }}"
                                                                data-popup-open="popup-2" data-backdrop="2"
                                                                data-show="1" data-toggle="modal"><i
                                                                class="material-icons">add_shopping_cart</i>
                                                        </button>
                                                    <span class="dot {{ $tire->dotAvailable }}" data-toggle="tooltip" data-html="true"
