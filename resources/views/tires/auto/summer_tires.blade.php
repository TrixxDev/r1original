...
@section('title', 'lang-' . app()->getLocale() . ' country-' . app()->getLocale() . ' layout-both-columns page-category tax-display-enabled category-id-14 category-vasaras-riepas category-id-parent-12 category-depth-level-3')
                        ...
                        <div id="search_filters" class="params">
                            ...
                            <div class="wrap">
                                ...
                                <div class="can-collapse">
                                    ...
                                    <form method="post" action="/{{ $season_title }}/search">
                                        @csrf
                                        ...
                                        @foreach ($tires as $tire)
                                            ...
                                            <article class="product_show_list cat-14 product-miniature js-product-miniature"
                                                ...
                                                <div class="thumbnail-container">
                                                    <a href="{{ route('vasaras-riepa', [strtolower(\Tires::getAutoTireBrand($tire->brand_id)->title), $tire->slug, $tire->tire_id]) }}"
                                                    ...
                                                    <div class="product-description">
                                                        ...
                                                        <h1 class="h3 product-title" itemprop="name">
                                                            <a data-toggle="tooltip" data-html="true"
                                                                @if ($tire->image)
                                                                    title="<img src='/storage/app/public/tread/{{ $tire->image }}'>"
                                                                @else
                                                                    title="<img src='{{ asset('img/p/en-default-home_default.jpg') }}'>"
                                                                @endif
                                                                href="{{ route('vasaras-riepa', [strtolower(\Tires::getAutoTireBrand($tire->brand_id)->title), $tire->slug, $tire->tire_id]) }}"
...
&nbsp;                                                      <span class="table-cell top40">Top 40</span>
                                                            ...
                                                            <div class="clearfix atc_div">
                                                                    <button class="btn grid-cart-btn btn-primary" data-toggle="modal" data-target="#blockcart-modal" data-info="{{ $tire->tire_id }}"><i
