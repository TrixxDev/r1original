      ...
      <div class="main-content clearfix col-md-12 col-xl-10">
        <div id="content-wrapper" class="right-column col-lg-12">
	      ...
	      @php
              ...
              @endphp
              <form method="POST" data-car-info-url="{{ url('/api/car-info') }}">
                @CSRF
		...
		<div class="stepper-wrapper">
		  ...
		  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="data[car_plate]" id="car_reg_nr"
                      value="@if (\Illuminate\Support\Facades\Session::has('cart.car_plate')){{\Illuminate\Support\Facades\Session::get('cart.car_plate')}}@endif"
                      placeholder="AA1234">
...
<script src="{{ asset('js/cart-car-info.js?rev=' . time()) }}"></script>
@endsection
