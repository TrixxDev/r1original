...
@section('meta_title', 'Iepirkšanās grozs | R1 Riepu Serviss')
@section('meta_description', 'Iepirkšanās grozs — pasūtiet riepas internetā ar piegādi visā Latvijā. Ērta pirkšana, drošs maksājums un montāža Rīgā vai Ulbrokā — R1 Riepu Serviss.')
@section('meta_keywords', config('seo.keywords.shop'))
                            ...
                            <div class="cart-grid-body @if ($cartCount > 0)col-xs-12 col-lg-8 @else col-xs-12 col-lg-12 @endif">
                                ...
                                <div class="card cart-container">
                                    ...
                                    @if(session()->has('cart') && count(session('cart')['products']) > 0)
                                        ...
                                        @php($productId = $product['id'] ?? $key)
                                        <div class="cart-item-table cart-item-container">
                                          <div class="item-name cart-item-name">
                                              <a href="{{ $product['url'] ?? '#' }}" data-id_customization="0" style="text-transform: uppercase;">{{ $product['name'] ?? ('ID: ' . $productId) }}</a>
                                              <br>
                                          ...
                                          <div class="qty-item">
                                            <div class="input-group bootstrap-touchspin">
                                              ...
                                              <input class="js-cart-line-product-quantity form-control" data-down-url="" data-up-url="" data-update-url="" data-item-price="{{ $product['price'] }}" data-product-id="{{ $productId }}" type="text" value="{{ $product['quantity'] }}" name="product-quantity-spin" min="1" style="display: block;">
                                          ...
                                          <div class="tire-price">
                                            <div class="price">
                                              <span class="product-price" data-product-id="{{ $productId }}">
                                          ...
                                          <div class="cart-trash">
                                            <div class="cart-line-product-actions">
                                              <a class="remove-from-cart" rel="nofollow" href="{{ route('shop.removeItem', $productId) }}" data-link-action="delete-from-cart" data-id-product="{{ $productId }}">
