...
<body id="@yield('body-title')" class="@yield('title') wait-loading" style="background-image: url('@if ((int) env('SEASON') === 1) /images/cover.webp @else /images/cover1.webp @endif')">
