                ...
                <div class="form-group row make-settings">
                  ...
                  <form method="post" style="display: flex;">
                    ...
                    <select name="make-season" style="width: 200px; margin-left: 10px; display: none;" class="form-control make-season">
                      <option value="1"
{{--                              @if (isset($tread) && $tread->season == 1) selected @endif--}}
                      >Vasaras</option>
                      <option value="2"
{{--                              @if (isset($tread) && $tread->season == 2) selected @endif--}}
                      >Ziemas</option>
                    </select>
...
{{--                  {!! App\Helper\Image::showGrid('studs', $tread->tread_id, 'width: 300px; margin-bottom: 20px;') !!}--}}
                  ...
                  <form action="
{{--                    {{ route('admin.auto.tires.image', $tread->tread_id) }}--}}
...
{{--                  {{ route('admin.auto.tires.create', $tread->tread_id) }}--}}
                ">Pievienot</a></button>
              </div>
{{--            @endif--}}
            <div class="row">
...
{{--                            {{ route('admin.auto.tire.edit', $tire->tire_id) }}--}}
                            ">
                            <svg class="c-icon">
...
{{--                            {{ route('admin.auto.tire.destroy', $tire->tire_id) }}--}}
                            ">
                            <svg class="c-icon">
