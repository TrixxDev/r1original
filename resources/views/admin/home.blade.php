...
@section('content')
    ...
    <div class="container-fluid">
	    ...
	    <div class="row mt-3">
			...
			<pre id="admin-rg-sync-out" class="d-none small mt-2 mb-4 mb-0 mx-3 mx-md-4 p-2 bg-light border rounded" style="max-height: 240px; overflow: auto; white-space: pre-wrap; word-break: break-word;"></pre>
                    </div>
                </div>
            </div>
            <div class="row mt-4">
...
// RG sinhronizācija no paneļa (bez jaunas cilnes — pieprasījums fonā, pēc tam atjauno laiku)
document.addEventListener('DOMContentLoaded', () => {
