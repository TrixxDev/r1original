            ...
            <div class="card">
                <form class="form-horizontal" action="{{ route('admin.auto.tire.update', $tire->tire_id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        @endif
			<div class="form-group row">
                            <label class="col-md-3 col-form-label" for="rgarticle">Riepu Garāža artikuls</label>
                            <div class="col-md-9">
                        ...
                        @if ($rgstock)
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="rgquantity">Riepu Garāža atlikums</label>
                            <div class="col-md-9">
