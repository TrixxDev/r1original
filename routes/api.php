...
Route::prefix('v1/shop')->middleware(['api', 'shop.guest'])->group(function () {
    Route::get('/tires/filters', [CatalogController::class, 'filterSizes']);
    Route::get('/tires', [CatalogController::class, 'index']);
    Route::get('/tires/{tireId}', [CatalogController::class, 'show'])->whereNumber('tireId');
    Route::get('/cart', [CartController::class, 'show']);
    Route::post('/cart', [CartController::class, 'add']);
    Route::patch('/cart/items/{itemId}', [CartController::class, 'updateItem'])->whereNumber('itemId');
    Route::delete('/cart/items/{itemId}', [CartController::class, 'deleteItem'])->whereNumber('itemId');
...
Route::prefix('v1/mobile')->middleware(['api', 'mobile.token'])->group(function () {
    ...
    Route::get('/slots/search', [MobileSlotsController::class, 'searchSlots']);
