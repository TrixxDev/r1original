$(document).ready(function() {
  function resolveTireAjaxUrl() {
    if (window.R1_TIRE_AJAX_URL) {
      return window.R1_TIRE_AJAX_URL;
    }
    if (window.location.pathname.includes('/vasaras-riepas/')) {
      return '/vasaras-riepas/ajax';
    }
    return '/ziemas-riepas/ajax';
  }
