...
//    'availability' => $this->availability
  ...
  protected function renderDualSizePairKitTotalFoot(Autotire $sizeA, Autotire $sizeB, bool $hasTypeColumn): string
  {
    ...
    $columnsBeforeTotal = $hasTypeColumn ? 10 : 9;

    return '<tfoot class="dual-size-pair-tfoot">'
      . '<tr class="dual-size-pair-total-row">'
      . '<td colspan="' . $columnsBeforeTotal . '" class="dual-size-pair-total-spacer"></td>'
      . '<td colspan="3" class="dual-size-pair-total-cell">'
  ...
  protected function renderAutoTireListTableOpening(
    ...
    $html .= '<th' . $storePriceButtonId . ' scope="col" class="text-center">Veikala cena</th>';
    $html .= '<th' . $storeSaleButtonId . ' scope="col" class="text-center">Akcijas cena</th>';
